...
### Maintenance
  ...
  - [x] [GN-43] Address issues in JS console on Firefox
    ...
    Opening multiple popups was blocked due to lack of user activation. client:80:240
    Storage access automatically granted for origin “https://accounts.google.com” on “http://localhost:8000”.
  - [x] [GN-43] There are horrendous UI regressions in the front-end, like a giant first note of a different color, or multicolumn editing mode where the markdown is in a narrow column on the right. What is really scary that tests are passing. FIXED: Reverted unwanted visual styling from commit 6526198.
