...
Gravity Notes is a single-page web application for taking notes using Markdown. Notes surface in a stable grid
with bounded HTML views, and every note edits inline—no modal overlays or context switches.. See README.md for details
