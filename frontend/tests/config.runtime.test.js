...
const MPR_UI_SCRIPT_URL_OVERRIDE = "https://cdn.example.com/mpr-ui.js";
...
const TEST_LABELS = Object.freeze({
    ...
    MPR_UI_SCRIPT_OVERRIDE: "createAppConfig respects injected mprUiScriptUrl",
...
test(TEST_LABELS.DEVELOPMENT_DEFAULTS, () => {
    ...
    assert.equal(appConfig.mprUiScriptUrl, DEVELOPMENT_ENVIRONMENT_CONFIG.mprUiScriptUrl);
...
test(TEST_LABELS.AUTH_BASE_OVERRIDE, () => {
    ...
    const appConfig = createAppConfig({
        ...
        mprUiScriptUrl: MPR_UI_SCRIPT_URL_OVERRIDE,
        googleClientId: DEFAULT_GOOGLE_CLIENT_ID
    });
...
test(TEST_LABELS.MPR_UI_SCRIPT_OVERRIDE, () => {
    const appConfig = createAppConfig({
        environment: ENVIRONMENT_DEVELOPMENT,
        mprUiScriptUrl: MPR_UI_SCRIPT_URL_OVERRIDE,
        googleClientId: DEFAULT_GOOGLE_CLIENT_ID
    ...
    assert.equal(appConfig.mprUiScriptUrl, MPR_UI_SCRIPT_URL_OVERRIDE);
});
