...
export const LABEL_LANDING_TITLE = "Notes that stay anchored.";
export const LABEL_LANDING_DESCRIPTION = "Markdown-first notes with inline editing and a no-jump grid. Sign in to sync your notebook.";
export const LABEL_LANDING_SIGN_IN_HINT = "Sign in with Google to open your notebook.";
export const LABEL_LANDING_STATUS_LOADING = "Checking your session...";
export const APP_BUILD_ID = "2026-01-01T22:43:21Z";
...
export const EVENT_MPR_AUTH_AUTHENTICATED = "mpr-ui:auth:authenticated";
export const EVENT_MPR_AUTH_UNAUTHENTICATED = "mpr-ui:auth:unauthenticated";
export const EVENT_MPR_AUTH_ERROR = "mpr-ui:auth:error";
export const EVENT_MPR_USER_MENU_ITEM = "mpr-user:menu-item";
